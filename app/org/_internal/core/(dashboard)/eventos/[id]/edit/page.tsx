// app/org/(dashboard)/eventos/[id]/edit/page.tsx
...
import { EventEditClient } from "@/app/org/_internal/core/(dashboard)/eventos/EventEditClient";
    ...
    <div className={cn("w-full py-8 space-y-6 text-white")}>
      ...
      <EventEditClient
        event={{
          ...
          address: event.addressRef?.formattedAddress ?? null,
