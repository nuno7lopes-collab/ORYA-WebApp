...
"[project]/app/inscricoes/[id]/FormSubmissionClient.tsx [app-rsc] (client reference proxy) <module evaluation>", ((__turbopack_context__) => {
"use strict";
...
;
const FormSubmissionClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call FormSubmissionClient() from the server but FormSubmissionClient is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/app/inscricoes/[id]/FormSubmissionClient.tsx <module evaluation>", "FormSubmissionClient");
}),
"[project]/app/inscricoes/[id]/FormSubmissionClient.tsx [app-rsc] (client reference proxy)", ((__turbopack_context__) => {
"use strict";
...
const FormSubmissionClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call FormSubmissionClient() from the server but FormSubmissionClient is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/app/inscricoes/[id]/FormSubmissionClient.tsx", "FormSubmissionClient");
}),
"[project]/app/inscricoes/[id]/FormSubmissionClient.tsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$inscricoes$2f5b$id$5d2f$FormSubmissionClient$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/app/inscricoes/[id]/FormSubmissionClient.tsx [app-rsc] (client reference proxy) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$inscricoes$2f5b$id$5d2f$FormSubmissionClient$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__ = __turbopack_context__.i("[project]/app/inscricoes/[id]/FormSubmissionClient.tsx [app-rsc] (client reference proxy)");
;
__turbopack_context__.n(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$inscricoes$2f5b$id$5d2f$FormSubmissionClient$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__);
}),
...
"[project]/app/inscricoes/[id]/page.tsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$inscricoes$2f5b$id$5d2f$FormSubmissionClient$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/inscricoes/[id]/FormSubmissionClient.tsx [app-rsc] (ecmascript)");
...
;
;
async function PublicFormPage({ params }) {
    const { id } = await params;
    const formId = Number(id);
    if (!formId || Number.isNaN(formId)) (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$navigation$2e$react$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["notFound"])();
    const form = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].organizationForm.findUnique({
        where: {
            id: formId
        },
        include: {
    ...
    const premiumActive = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$organizerPremium$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isCustomPremiumActive"])(form.organizer);
    const premiumModules = premiumActive ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$organizerPremium$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getCustomPremiumProfileModules"])(form.organizer) ?? {} : {};
    const allowInscricoes = Boolean(premiumModules.inscricoes);
    const isPublic = form.status !== "ARCHIVED";
    if (!isPublic) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$navigation$2e$react$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["notFound"])();
    }
    const moduleEnabled = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].organizationModuleEntry.findFirst({
        where: {
            organizerId: form.organizer.id,
    ...
    const organizerName = form.organizer.publicName || form.organizer.businessName || form.organizer.username || "Organização";
    const fields = form.fields.map((field)=>({
            ...
            options: Array.isArray(field.options) ? field.options.map((opt)=>String(opt)) : null
        }));
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$inscricoes$2f5b$id$5d2f$FormSubmissionClient$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["FormSubmissionClient"], {
        form: {
            id: form.id,
            title: form.title,
        ...
        fileName: "[project]/app/inscricoes/[id]/page.tsx",
        lineNumber: 70,
        columnNumber: 5
    }, this);
}
...
"[project]/app/inscricoes/[id]/page.tsx [app-rsc] (ecmascript, Next.js Server Component)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/app/inscricoes/[id]/page.tsx [app-rsc] (ecmascript)"));
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__8a683055._.js.map