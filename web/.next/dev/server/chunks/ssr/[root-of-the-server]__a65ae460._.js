...
"[project]/app/organizador/OrganizerShell.tsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function OrganizerShell({ children, sidebar, organizerLanguage, organizerUsername, brandPrimary, brandSecondary }) {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$organizador$2f$OrganizerLangSetter$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["OrganizerLangSetter"], {
                    ...
                    fileName: "[project]/app/organizador/OrganizerShell.tsx",
                    lineNumber: 34,
                    columnNumber: 9
                }, this),
...
"[project]/app/organizador/organizerShellData.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

return __turbopack_context__.a(async (__turbopack_handle_async_dependencies__, __turbopack_async_result__) => { try {

__turbopack_context__.s([
    "getOrganizerShellData",
    ()=>getOrganizerShellData
]);
...
;
;
async function getOrganizerShellData() {
    ...
    try {
        ...
        if (organizer && membership) {
            activeOrganizer = {
                ...
                organizationCategory: organizer.organizationCategory ?? null,
                city: organizer.city ?? null,
                entityType: organizer.entityType ?? null,
                status: organizer.status ?? null,
                language: organizer.language ?? null
            };
        }
    } catch  {
        currentId = null;
    ...
    try {
        const memberships = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].organizerMember.findMany({
            where: {
                userId: user.id
            },
            include: {
        ...
        orgOptions = memberships.filter((m)=>m.organizer).map((m)=>({
                ...
                organizer: {
                    ...
                    organizationKind: m.organizer.organizationKind ?? null,
                    organizationCategory: m.organizer.organizationCategory ?? null,
                    status: m.organizer.status,
                    brandingAvatarUrl: m.organizer.brandingAvatarUrl ?? null,
                    brandingPrimaryColor: m.organizer.brandingPrimaryColor ?? null,
                    brandingSecondaryColor: m.organizer.brandingSecondaryColor ?? null,
                    language: m.organizer.language ?? null
                }
            }));
    } catch (err) {
        const msg = typeof err === "object" && err && "message" in err ? String(err.message) : "";
    ...
    const organizerName = activeOrganizer?.publicName || activeOrganizer?.businessName || "Organizador";
...
"[project]/app/organizador/eventos/novo/layout.tsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$organizador$2f$OrganizerShell$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/organizador/OrganizerShell.tsx [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$organizador$2f$organizerShellData$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/organizador/organizerShellData.ts [app-rsc] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$organizador$2f$organizerShellData$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$organizador$2f$organizerShellData$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
...
;
;
async function OrganizerEventCreateLayout({ children }) {
    const shell = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$organizador$2f$organizerShellData$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getOrganizerShellData"])();
    if (!shell) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$organizador$2f$OrganizerShell$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["OrganizerShell"], {
        ...
        sidebar: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$app$2d$sidebar$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["AppSidebar"], {
            ...
            fileName: "[project]/app/organizador/eventos/novo/layout.tsx",
            lineNumber: 22,
            columnNumber: 9
        }, void 0),
        children: children
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a65ae460._.js.map