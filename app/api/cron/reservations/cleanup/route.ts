...
async function _GET(req: NextRequest) {
  ...
  try {
    ...
    await recordCronHeartbeat("reservations-cleanup", { status: "SUCCESS", startedAt });
    return jsonWrap({
      ok: true,
    ...
    await recordCronHeartbeat("reservations-cleanup", { status: "ERROR", startedAt, error: err });
    return jsonWrap(
