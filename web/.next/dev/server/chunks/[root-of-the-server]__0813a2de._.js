...
"[project]/app/api/organizador/estatisticas/overview/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        let totalTickets = summaries.reduce((acc, s)=>acc + s.lines.reduce((q, l)=>q + (l.quantity ?? 0), 0), 0);
        ...
        let platformFeeCents = summaries.reduce((acc, s)=>acc + (s.platformFeeCents ?? 0), 0);
        ...
        const activeEventsCount = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].event.count({
            where: {
                organizerId: organizer.id,
                status: __TURBOPACK__imported__module__$5b$externals$5d2f40$prisma$2f$client__$5b$external$5d$__$2840$prisma$2f$client$2c$__cjs$29$__["EventStatus"].PUBLISHED
            }
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: true,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0813a2de._.js.map