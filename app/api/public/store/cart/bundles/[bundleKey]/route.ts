...
async function _PATCH(
  ...
  try {
    ...
    if (!bundleId) {
      return jsonWrap({ ok: false, error: "Bundle invalido." }, { status: 404 });
    }
    ...
    console.error("PATCH /api/public/store/cart/bundles/[bundleKey] error:", err);
...
async function _DELETE(
  ...
  try {
    ...
    console.error("DELETE /api/public/store/cart/bundles/[bundleKey] error:", err);
