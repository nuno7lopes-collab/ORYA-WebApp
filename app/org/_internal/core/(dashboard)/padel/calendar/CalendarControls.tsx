...
export function CalendarControls(props: {
  ...
  return (
    <div className="space-y-2">
          ...
          <div className="flex items-center gap-2 rounded-full border border-white/20 bg-white/5 px-3 py-1 text-[12px] text-white/80">
            ...
            >
              {props.categoryOptions.map((option) => (
                <option
                  key={`calendar-category-${option.key}`}
                  value={option.key}
                >
                  {option.label}
                </option>
          ...
          <div className="inline-flex rounded-full border border-white/15 bg-white/5 p-1 text-[12px]">
            {[
              ...
              <button
                ...
                type="button"
                onClick={() =>
                  props.onCalendarFilterChange(opt.key as "all" | "club")
                }
                className={`rounded-full px-3 py-1 font-semibold transition ${
      ...
      <details className="rounded-xl border border-white/12 bg-black/20 px-3 py-2 text-[12px] text-white/75">
          ...
          <div className="inline-flex rounded-full border border-white/15 bg-white/5 p-1 text-[12px]">
            {[
              ...
              <button
                ...
                type="button"
                onClick={() =>
                  props.onCalendarDataViewChange(
                    opt.key as "complete" | "games",
                  )
                }
                className={`rounded-full px-3 py-1 font-semibold transition ${
