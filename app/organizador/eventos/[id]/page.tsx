...
export default async function OrganizerEventDetailPage({ params }: PageProps) {
  ...
  return (
    <div className="w-full space-y-7 px-4 py-8 text-white md:px-6 lg:px-8">
      <div id="resumo" className="rounded-3xl border border-white/12 bg-gradient-to-br from-white/8 via-[#0b1124]/70 to-[#050810]/90 p-5 shadow-[0_24px_80px_rgba(0,0,0,0.55)] backdrop-blur-2xl">
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          <div className="space-y-1">
            <p className="text-[11px] uppercase tracking-[0.3em] text-white/70">Gestão de {eventLabel}</p>
          ...
          <div className="flex flex-wrap gap-2 text-[11px]">
            <a href="/organizador" className={CTA_SECONDARY}>
              ← Voltar à lista
            </a>
            <a
            ...
            >
              {isPadel ? "Ver página do torneio" : "Ver página pública"}
            </a>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div className="rounded-2xl border border-[#6BFFFF]/40 bg-[#02040b]/95 backdrop-blur-xl px-4 py-3.5">
            <p className="text-[11px] text-[#6BFFFF]/80">
              {isPadel ? "Inscrições vendidas" : "Bilhetes vendidos"}
            </p>
          ...
          <div className="rounded-2xl border border-white/14 bg-white/5 backdrop-blur-xl px-4 py-3.5">
            ...
            <p className="mt-1 text-[11px] text-white/55">
              {isPadel
                ? "Calculado com base em preço × inscrições vendidas, por wave."
      ...
      <section id="bilhetes" className="rounded-2xl border border-white/12 bg-black/40 backdrop-blur-xl p-5 space-y-4">
        ...
        {event.ticketTypes.length === 0 && (
          <div className="mt-2 rounded-xl border border-dashed border-white/20 bg-white/5 px-4 py-4 text-[11px] text-white/70">
            Este {eventLabel} ainda não tem waves configuradas. Usa o criador de
            {eventLabelPlural} para adicionar {ticketLabelPlural}.
          </div>
        )}
