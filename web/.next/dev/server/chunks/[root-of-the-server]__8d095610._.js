...
"[project]/app/api/padel/tournaments/config/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    if (!organizer || !membership) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ok: false,
        error: "FORBIDDEN"
    }, {
        status: 403
...
async function POST(req) {
    ...
    const enabledFormats = Array.isArray(body.enabledFormats) ? body.enabledFormats.map((f)=>String(f)) : null;
    const groupsConfig = body.groups && typeof body.groups === "object" ? {
        mode: body.groups.mode === "MANUAL" ? "MANUAL" : "AUTO",
        groupCount: Number(body.groups.groupCount),
        groupSize: Number(body.groups.groupSize),
        qualifyPerGroup: Number(body.groups.qualifyPerGroup),
        seeding: body.groups.seeding === "NONE" ? "NONE" : "SNAKE"
    } : null;
    ...
    try {
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].padelTournamentConfig.findUnique({
            where: {
                eventId
            },
            select: {
        ...
        const config = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].padelTournamentConfig.upsert({
            where: {
                eventId
            },
            create: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8d095610._.js.map