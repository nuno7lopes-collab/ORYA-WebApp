...
export function FiltersDrawer({
  ...
  useEffect(() => {
    ...
    setExpanded({
      status: true,
      type: draftFilters.bookingTypes.length > 0,
      channel: draftFilters.channels.length > 0,
      payment: draftFilters.paymentStatuses.length > 0,
      services: draftFilters.serviceIds.length > 0,
      createdAt: Boolean(draftFilters.createdFrom || draftFilters.createdTo),
      requestedProfessional: draftFilters.requestedProfessionalIds.length > 0,
    });
  }, [
    open,
    draftFilters.bookingTypes.length,
    draftFilters.channels.length,
    draftFilters.paymentStatuses.length,
    draftFilters.serviceIds.length,
    draftFilters.createdFrom,
    draftFilters.createdTo,
    draftFilters.requestedProfessionalIds.length,
  ]);
