...
## Budgets & Alarms (2026-02-01)
- SNS topics + subscriptions confirmados (EU/US) para admin@orya.pt.
- Budget global criado: `ORYA-BUDGET-MONTHLY-75USD` (USD 75, ACTUAL+FORECAST, thresholds 25/50/60/65/70).
- Alarms CloudWatch (ALB/ECS/SES) criados e ativos.
- Evidence: `reports/infra_alerts_2026-02-01.md`

## Admin Infra tab (read-only)
- UI infra disponível em `/admin/infra` com custos/uso/alertas.
- Endpoints AWS SDK v3 (Cost Explorer + ECS/ALB + Budgets/CloudWatch).
- Read-only por defeito: `NEXT_PUBLIC_INFRA_READ_ONLY=true`.
- Evidence: `reports/infra_tab_2026-02-01.md`
