        ...
        <div className="grid gap-3 md:grid-cols-2">
          ...
          <div className="space-y-1">
            ...
            <input
              value={publicName}
              disabled
              className="w-full rounded-xl border border-white/15 bg-black/30 px-3 py-2 text-sm outline-none focus:border-[#6BFFFF] disabled:cursor-not-allowed disabled:opacity-70"
              placeholder="Ex.: XPTO Events"
            />
            <p className="text-[11px] text-white/55">
              Edita no{" "}
              <Link href="/organizador?tab=profile" className="text-[#6BFFFF] hover:underline">
                Perfil
              </Link>
              .
            </p>
