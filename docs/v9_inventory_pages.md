...
| /admin/config/platform-email | app/admin/config/platform-email/page.tsx | - | admin |
| /admin/eventos | app/admin/eventos/page.tsx | - | admin |
| /admin/finance | app/admin/finance/page.tsx | - | admin |
| /admin/organizacoes | app/admin/organizacoes/page.tsx | - | admin |
| /admin/payments | app/admin/payments/page.tsx | - | admin |
| /admin/payouts | app/admin/payouts/page.tsx | - | admin |
| /admin/refunds | app/admin/refunds/page.tsx | - | admin |
| /admin/settings | app/admin/settings/page.tsx | - | admin |
| /admin/tickets | app/admin/tickets/page.tsx | - | admin |
| /admin/utilizadores | app/admin/utilizadores/page.tsx | - | admin |
...
| /explorar/eventos | app/explorar/eventos/page.tsx | - | public |
| /explorar/reservas | app/explorar/reservas/page.tsx | - | reservas |
| /explorar/torneios | app/explorar/torneios/page.tsx | - | public |
...
| /organizacao/padel/mix/novo | app/organizacao/(dashboard)/padel/mix/novo/page.tsx | (dashboard) | organizacao, padel |
