...
const jobs = [
  ...
  },
  {
    ...
    method: "POST",
    path: "/api/cron/telemetry/rollup",
    intervalMs: getInterval("CRON_TELEMETRY_ROLLUP_INTERVAL_MS", 300000),
  },
  {
    name: "telemetry-alerts-evaluate",
    method: "POST",
    path: "/api/cron/telemetry/evaluate",
