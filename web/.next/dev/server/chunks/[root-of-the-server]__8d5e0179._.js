...
"[project]/app/api/padel/players/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    const players = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].padelPlayerProfile.findMany({
        where: {
            organizerId: organizer.id
        },
        orderBy: [
...
async function POST(req) {
    ...
    if (!fullName) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ok: false,
    ...
    try {
        const player = email ? await (async ()=>{
            const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].padelPlayerProfile.findFirst({
                where: {
                    organizerId: organizer.id,
                    email
                },
            ...
            if (existing?.id) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].padelPlayerProfile.update({
                    where: {
                        id: existing.id
                    },
                    data: {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].padelPlayerProfile.create({
                data: {
                    organizerId: organizer.id,
                    fullName,
                    displayName: displayName || fullName,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8d5e0179._.js.map