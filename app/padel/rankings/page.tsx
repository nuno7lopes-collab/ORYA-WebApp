...
export default function PadelGlobalRankingsPage() {
  return (
        ...
        <div className="rounded-3xl border border-white/12 bg-gradient-to-br from-white/8 via-[#0b1226]/75 to-[#050810]/90 p-6 shadow-[0_26px_70px_rgba(0,0,0,0.6)] backdrop-blur-2xl">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="space-y-2">
              <p className="text-[11px] uppercase tracking-[0.28em] text-white/60">Ranking Padel</p>
              <h1 className="text-3xl font-semibold">Top jogadores em destaque</h1>
              <p className="text-sm text-white/70">
                Ranking global com base nos pontos registados em torneios publicados.
              </p>
            ...
            <div className="rounded-2xl border border-white/15 bg-black/40 px-4 py-3 text-[11px] text-white/65">
              <p className="uppercase tracking-[0.2em] text-white/50">Pontos</p>
              <p className="mt-2 text-sm text-white/80">
                Gerados automaticamente a partir de resultados oficiais.
              </p>
            </div>
          </div>
        </div>
