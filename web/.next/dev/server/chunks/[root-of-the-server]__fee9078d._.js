...
"[project]/app/api/organizador/organizations/switch/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        // Validar membership
        const membership = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].organizerMember.findFirst({
            where: {
                organizerId,
                userId: user.id,
                organizer: {
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].organizerMember.updateMany({
                where: {
                    organizerId,
                    userId: user.id
                },
            ...
            if (!(typeof err === "object" && err && "code" in err && err.code === "P2021")) {
                throw err;
            }
        }
        ...
        if (typeof err === "object" && err && "code" in err && err.code === "P2021") {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                ok: false,
                error: "Base de dados sem tabela organizer_members. Corre as migrations."
            }, {
                status: 500
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fee9078d._.js.map