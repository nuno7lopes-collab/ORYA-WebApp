...
async function _PATCH(
  ...
  try {
    ...
    console.error("PATCH /api/organizacao/servicos/[id]/packages/[packageId] error:", err);
...
async function _DELETE(
  ...
  try {
    ...
    console.error("DELETE /api/organizacao/servicos/[id]/packages/[packageId] error:", err);
