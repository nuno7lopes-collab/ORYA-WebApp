...
"[project]/lib/stripeClient.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const stripe = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stripe$2f$esm$2f$stripe$2e$esm$2e$node$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$env$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["env"].stripeSecretKey, {
    maxNetworkRetries: 2,
    timeout: 20000
});
}),
...
"[project]/app/api/organizador/payouts/status/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$stripeClient$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/stripeClient.ts [app-route] (ecmascript)");
...
[__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$organizerContext$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$notifications$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
...
async function GET(req) {
    try {
        ...
        if (!organizer || !membership || !(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$organizerPermissions$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isOrgOwner"])(membership.role)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                ok: false,
                error: "APENAS_OWNER"
            }, {
        ...
        if (!organizer.stripeAccountId) {
            console.log("[stripe][status] no account", {
                organizerId: organizer.id
            });
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                ok: true,
        ...
        const account = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$stripeClient$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["stripe"].accounts.retrieve(organizer.stripeAccountId);
        ...
        const status = charges_enabled && payouts_enabled && (!requirements_due || requirements_due.length === 0) ? "CONNECTED" : "INCOMPLETE";
        ...
        if (status === "INCOMPLETE" && requirements_due && requirements_due.length > 0) {
            const owners = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].organizerMember.findMany({
                where: {
                    organizerId: organizer.id,
                    role: {
                        in: [
            ...
            await Promise.all(uniq.map(async (uid)=>{
                if (!await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$notifications$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["shouldNotify"])(uid, __TURBOPACK__imported__module__$5b$externals$5d2f40$prisma$2f$client__$5b$external$5d$__$2840$prisma$2f$client$2c$__cjs$29$__["NotificationType"].STRIPE_STATUS)) return;
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$notifications$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createNotification"])({
                    userId: uid,
                    type: __TURBOPACK__imported__module__$5b$externals$5d2f40$prisma$2f$client__$5b$external$5d$__$2840$prisma$2f$client$2c$__cjs$29$__["NotificationType"].STRIPE_STATUS,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8b99b36f._.js.map