  ...
  it("blocks booking.status usage outside workflow/scheduling allowlist", () => {
    assertNoMatches(
      [
        ...
        "-g '!app/api/chat/bookings/[[]bookingId[]]/messages/route.ts'",
        "-g '!app/api/chat/messages/route.ts'",
        "-g '!app/api/me/messages/conversations/[[]conversationId[]]/messages/route.ts'",
        "-g '!app/api/me/messages/bookings/[[]bookingId[]]/messages/route.ts'",
        "-g '!app/api/organizacao/reservas/summary/route.ts'",
        "-g '!app/api/organizacao/reservas/[[]id[]]/charges/route.ts'",
