...
export default async function OrganizationAnalyzePage({
  ...
  if (!params.get("organizationId")) {
    ...
    redirect(`/organizacao/analyze?${params.toString()}`);
  }

  const defaultSection =
    typeof resolvedSearchParams?.section === "string" ? resolvedSearchParams.section : "overview";

  return <DashboardClient hasOrganization defaultObjective="analyze" defaultSection={defaultSection} />;
}
