...
import { DASHBOARD_CARD, CTA_NEUTRAL, CTA_SECONDARY } from "@/app/organizacao/dashboardUi";
    ...
    <div className="space-y-4">
      <div className={cn(DASHBOARD_CARD, "p-4 space-y-3")}>
        <div className="flex flex-wrap items-center justify-between gap-2">
          ...
          <Link href="/organizacao/crm/campanhas" className={cn(CTA_SECONDARY, "px-3 py-1 text-[11px]")}>
            Ir para campanhas
          </Link>
        </div>
