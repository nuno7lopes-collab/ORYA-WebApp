...
"[project]/app/api/organizador/inscricoes/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function ensureInscricoesEnabled(organizer) {
    const premiumActive = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$organizerPremium$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isCustomPremiumActive"])(organizer);
    const premiumModules = premiumActive ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$organizerPremium$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCustomPremiumProfileModules"])(organizer) ?? {} : {};
    if (!premiumModules.inscricoes) return false;
    const enabled = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].organizationModuleEntry.findFirst({
        where: {
            organizerId: organizer.id,
...
async function GET(req) {
    try {
        ...
        if (!await ensureInscricoesEnabled(organizer)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                ok: false,
                error: "Módulo de inscrições desativado."
            }, {
                status: 403
            });
        }
        const forms = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].organizationForm.findMany({
            where: {
                organizerId: organizer.id
            },
            orderBy: [
...
async function POST(req) {
    try {
        ...
        const waitlistRaw = body.waitlistEnabled;
        ...
        const capacity = typeof capacityRaw === "number" && Number.isFinite(capacityRaw) ? Math.max(0, Math.floor(capacityRaw)) : null;
        ...
        if (!title) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                ok: false,
                error: "Indica um título para o formulário."
            }, {
                status: 400
            });
        }
        const form = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction(async (tx)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1f49c13b._.js.map