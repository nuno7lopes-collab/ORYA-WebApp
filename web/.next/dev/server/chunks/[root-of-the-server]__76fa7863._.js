...
"[project]/lib/operations/enqueue.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function enqueueOperation(params) {
    const { operationType, dedupeKey, status = "PENDING", payload = {}, correlations = {} } = params;
    const insert = async ()=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$executeRaw(__TURBOPACK__imported__module__$5b$externals$5d2f40$prisma$2f$client__$5b$external$5d$__$2840$prisma$2f$client$2c$__cjs$29$__["Prisma"].sql`
    ...
    try {
        ...
        if (message.includes('OperationStatus')) {
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$executeRawUnsafe(`DO $$ BEGIN
           ...
           END $$;`);
                ...
                console.error("[operations][enqueue] heal OperationStatus failed", {
                    dedupeKey,
                    healErr
                });
            }
        }
        console.error("[operations][enqueue] failed", {
            operationType,
            dedupeKey,
            err
        });
...
"[project]/app/api/me/claim-guest/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$operations$2f$enqueue$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/operations/enqueue.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/prisma.ts [app-route] (ecmascript)");
...
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$operations$2f$enqueue$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__,
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$operations$2f$enqueue$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
...
async function POST(req) {
    ...
    const verified = Boolean(user?.email_confirmed_at || user?.emailConfirmedAt);
    if (!verified) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    const normEmail = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$email$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizeEmail"])(user.email ?? "");
    ...
    const identity = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].emailIdentity.upsert({
        where: {
            emailNormalized
        },
        update: {
    ...
    if (purchaseIdFromBody) {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$operations$2f$enqueue$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["enqueueOperation"])({
    ...
    const purchases = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].entitlement.findMany({
        where: {
            ownerUserId: null,
            OR: [
                {
    ...
    if (!purchases.length) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: true,
            enqueued: false,
            reason: "NO_GUEST_ENTITLEMENTS"
        });
    }
    await Promise.all(purchases.map((p)=>p.purchaseId).filter((p)=>!!p).map((pid)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$operations$2f$enqueue$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["enqueueOperation"])({
            operationType: "CLAIM_GUEST_PURCHASE",
            purchaseId: pid,
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ok: true,
        enqueued: true,
        purchases: purchases.map((p)=>p.purchaseId)
    });
}
__turbopack_async_result__();
} catch(e) { __turbopack_async_result__(e); } }, false);}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__76fa7863._.js.map