...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| /api/address/autocomplete | app/api/address/autocomplete/route.ts | GET | public | none detected | none detected | unknown | nodejs/default/default | default | withApiEnvelope | - |
| /api/address/details | app/api/address/details/route.ts | GET | public | none detected | none detected | unknown | nodejs/default/default | default | withApiEnvelope | - |
| /api/address/reverse | app/api/address/reverse/route.ts | GET | public | none detected | none detected | unknown | nodejs/default/default | default | withApiEnvelope | - |
| /api/admin/config/platform-email | app/api/admin/config/platform-email/route.ts | GET, POST | admin | admin | json | 200 | default/default/default | default | respond* | - |
...
| /api/admin/infra/alerts/status | app/api/admin/infra/alerts/status/route.ts | GET | admin | admin | none detected | 500 | nodejs/force-dynamic/default | dynamic exported | respond* | - |
| /api/admin/infra/cost/summary | app/api/admin/infra/cost/summary/route.ts | GET | admin | admin | query | 500 | nodejs/force-dynamic/default | dynamic exported | respond* | - |
| /api/admin/infra/deploy | app/api/admin/infra/deploy/route.ts | POST | admin | admin | json | 500 | nodejs/force-dynamic/default | dynamic exported | respond* | - |
| /api/admin/infra/hard-pause | app/api/admin/infra/hard-pause/route.ts | POST | admin | admin | json | 500 | nodejs/force-dynamic/default | dynamic exported | respond* | - |
| /api/admin/infra/migrate | app/api/admin/infra/migrate/route.ts | POST | admin | admin | json | 500 | nodejs/force-dynamic/default | dynamic exported | respond* | - |
| /api/admin/infra/resume | app/api/admin/infra/resume/route.ts | POST | admin | admin | json | 500 | nodejs/force-dynamic/default | dynamic exported | respond* | - |
| /api/admin/infra/rotate-secrets | app/api/admin/infra/rotate-secrets/route.ts | POST | admin | admin | json | 500 | nodejs/force-dynamic/default | dynamic exported | respond* | - |
| /api/admin/infra/soft-pause | app/api/admin/infra/soft-pause/route.ts | POST | admin | admin | json | 500 | nodejs/force-dynamic/default | dynamic exported | respond* | - |
| /api/admin/infra/start | app/api/admin/infra/start/route.ts | POST | admin | admin | json | 500 | nodejs/force-dynamic/default | dynamic exported | respond* | - |
| /api/admin/infra/status | app/api/admin/infra/status/route.ts | GET | admin | admin | none detected | 500 | nodejs/force-dynamic/default | dynamic exported | respond* | - |
| /api/admin/infra/usage/summary | app/api/admin/infra/usage/summary/route.ts | GET | admin | admin | none detected | 500 | nodejs/force-dynamic/default | dynamic exported | respond* | - |
| /api/admin/mfa/enroll | app/api/admin/mfa/enroll/route.ts | POST | admin | admin | none detected | 500 | nodejs/force-dynamic/default | dynamic exported | respond* | - |
| /api/admin/mfa/reset | app/api/admin/mfa/reset/route.ts | POST | admin | admin | json | 500 | nodejs/force-dynamic/default | dynamic exported | respond* | - |
| /api/admin/mfa/session | app/api/admin/mfa/session/route.ts | GET | admin | admin | none detected | 500 | nodejs/force-dynamic/default | dynamic exported | respond* | - |
| /api/admin/mfa/status | app/api/admin/mfa/status/route.ts | GET | admin | admin | none detected | 500 | nodejs/force-dynamic/default | dynamic exported | respond* | - |
| /api/admin/mfa/verify | app/api/admin/mfa/verify/route.ts | POST | admin | admin | json | 500 | nodejs/force-dynamic/default | dynamic exported | respond* | - |
...
| /api/admin/organizacoes/verify-platform-email | app/api/admin/organizacoes/verify-platform-email/route.ts | POST | admin | admin | json | 200 | default/default/default | default | respond* | - |
| /api/admin/payments/dispute | app/api/admin/payments/dispute/route.ts | POST | admin | admin | json | 200, 400, 404, 500 | default/default/default | default | respond* | - |
...
| /api/admin/payments/refund | app/api/admin/payments/refund/route.ts | POST | admin | admin | json | 200, 400, 404, 500 | default/default/default | default | respond* | - |
| /api/admin/payments/reprocess | app/api/admin/payments/reprocess/route.ts | POST | admin | admin | json | 200, 400, 500 | default/default/default | default | respond* | - |
| /api/admin/payouts/[id] | app/api/admin/payouts/[id]/route.ts | GET | admin | admin | none detected | 200, 400, 404, 500 | default/default/default | default | respond* | - |
| /api/admin/payouts/[id]/block | app/api/admin/payouts/[id]/block/route.ts | POST | admin | admin | json | 200, 400, 404, 409 | default/default/default | default | respond* | - |
| /api/admin/payouts/[id]/cancel | app/api/admin/payouts/[id]/cancel/route.ts | POST | admin | admin | json | 200, 400, 404, 409 | default/default/default | default | respond* | - |
| /api/admin/payouts/[id]/force-release | app/api/admin/payouts/[id]/force-release/route.ts | POST | admin | admin | none detected | 200, 400, 404, 409 | default/default/default | default | respond* | - |
| /api/admin/payouts/[id]/unblock | app/api/admin/payouts/[id]/unblock/route.ts | POST | admin | admin | none detected | 200, 400, 404, 409 | default/default/default | default | respond* | - |
| /api/admin/payouts/list | app/api/admin/payouts/list/route.ts | GET | admin | admin | query | 200, 500 | default/default/default | default | respond* | - |
| /api/admin/refunds/list | app/api/admin/refunds/list/route.ts | GET | admin | admin | query | 200, 500 | default/default/default | default | respond* | - |
| /api/admin/refunds/retry | app/api/admin/refunds/retry/route.ts | POST | admin | admin | json | 200, 400, 404, 500 | default/default/default | default | respond* | - |
...
| /api/auth/resend-otp | app/api/auth/resend-otp/route.ts | POST | public | none detected | json | 400, 403, 429, 500, 502 | default/default/default | default | withApiEnvelope | - |
...
| /api/checkout/status | app/api/checkout/status/route.ts | GET | public | none detected | query | 200, 400, 500 | default/default/default | default | respond* | - |
...
| /api/cron/operations | app/api/cron/operations/route.ts | POST | cron | internal | none detected | 200, 401, 500 | nodejs/force-dynamic/default | dynamic exported | respond* | - |
...
| /api/cron/payouts/release | app/api/cron/payouts/release/route.ts | POST | cron | internal | none detected | 200, 401, 500 | nodejs/force-dynamic/default | dynamic exported | respond* | - |
...
| /api/eventos/[slug]/invite-token | app/api/eventos/[slug]/invite-token/route.ts | POST | public | none detected | json | 500 | default/default/default | default | respond* | - |
| /api/eventos/[slug]/invites/check | app/api/eventos/[slug]/invites/check/route.ts | POST | public | none detected | json | 500 | default/default/default | default | respond* | - |
...
| /api/geo/autocomplete | app/api/geo/autocomplete/route.ts | GET | public | none detected | query | 429 | nodejs/default/default | default | withApiEnvelope | - |
...
| /api/internal/checkin/consume | app/api/internal/checkin/consume/route.ts | POST | internal | internal | json | 401, 500 | nodejs/force-dynamic/default | dynamic exported | respond* | - |
| /api/internal/checkout/timeline | app/api/internal/checkout/timeline/route.ts | GET | internal | internal | query | 200, 400, 401 | default/default/default | default | respond* | - |
...
| /api/internal/cron/coverage | app/api/internal/cron/coverage/route.ts | GET | internal | internal | none detected | 200, 401 | nodejs/force-dynamic/default | dynamic exported | respond* | - |
...
| /api/internal/outbox/dlq | app/api/internal/outbox/dlq/route.ts | GET | internal | internal | query | 401 | default/default/default | default | respond* | - |
| /api/internal/outbox/replay | app/api/internal/outbox/replay/route.ts | POST | internal | internal | json | 400, 401, 404 | default/default/default | default | respond* | - |
...
| /api/internal/reconcile | app/api/internal/reconcile/route.ts | POST | internal | internal | json | 200, 401 | nodejs/force-dynamic/default | dynamic exported | respond* | - |
| /api/internal/reprocess/payment-intent | app/api/internal/reprocess/payment-intent/route.ts | POST | internal | internal | json | 200, 400, 401 | nodejs/force-dynamic/default | dynamic exported | respond* | - |
| /api/internal/reprocess/purchase | app/api/internal/reprocess/purchase/route.ts | POST | internal | internal | json | 200, 400, 401 | nodejs/force-dynamic/default | dynamic exported | respond* | - |
| /api/internal/reprocess/stripe-event | app/api/internal/reprocess/stripe-event/route.ts | POST | internal | internal | json | 200, 400, 401 | nodejs/force-dynamic/default | dynamic exported | respond* | - |
| /api/internal/worker/operations | app/api/internal/worker/operations/route.ts | POST | internal | internal | none detected | 200, 401 | nodejs/force-dynamic/default | dynamic exported | respond* | - |
...
| /api/me/reservas | app/api/me/reservas/route.ts | GET | me | user | none detected | unknown | default/default/default | default | respond* | - |
...
| /api/me/reservas/[id]/cancel | app/api/me/reservas/[id]/cancel/route.ts | POST | me | user | json | unknown | default/default/default | default | respond* | - |
...
| /api/me/reservas/[id]/invites/resend | app/api/me/reservas/[id]/invites/resend/route.ts | POST | me | user | json | 200 | default/default/default | default | withApiEnvelope | - |
...
| /api/me/store/bundles | app/api/me/store/bundles/route.ts | GET, POST | me | user | json | 201 | default/default/default | default | withApiEnvelope | - |
| /api/me/store/bundles/[id] | app/api/me/store/bundles/[id]/route.ts | DELETE, PATCH | me | user | json | unknown | default/default/default | default | withApiEnvelope | - |
| /api/me/store/bundles/[id]/items | app/api/me/store/bundles/[id]/items/route.ts | GET, POST | me | user | json | 201 | default/default/default | default | withApiEnvelope | - |
| /api/me/store/bundles/[id]/items/[itemId] | app/api/me/store/bundles/[id]/items/[itemId]/route.ts | DELETE, PATCH | me | user | json | unknown | default/default/default | default | withApiEnvelope | - |
| /api/me/store/categories | app/api/me/store/categories/route.ts | GET, POST | me | user | json | 201 | default/default/default | default | withApiEnvelope | - |
| /api/me/store/categories/[id] | app/api/me/store/categories/[id]/route.ts | DELETE, PATCH | me | user | json | unknown | default/default/default | default | withApiEnvelope | - |
| /api/me/store/orders | app/api/me/store/orders/route.ts | GET | me | user | query | unknown | default/default/default | default | withApiEnvelope | - |
| /api/me/store/orders/[orderId] | app/api/me/store/orders/[orderId]/route.ts | GET, PATCH | me | user | json | unknown | default/default/default | default | withApiEnvelope | - |
| /api/me/store/orders/[orderId]/shipments | app/api/me/store/orders/[orderId]/shipments/route.ts | POST | me | user | json | 201 | default/default/default | default | withApiEnvelope | - |
| /api/me/store/overview | app/api/me/store/overview/route.ts | GET | me | user | none detected | unknown | default/default/default | default | respond* | - |
| /api/me/store/products | app/api/me/store/products/route.ts | GET, POST | me | user | json | 201 | default/default/default | default | withApiEnvelope | - |
| /api/me/store/products/[id] | app/api/me/store/products/[id]/route.ts | DELETE, PATCH | me | user | json | unknown | default/default/default | default | withApiEnvelope | - |
| /api/me/store/products/[id]/digital-assets | app/api/me/store/products/[id]/digital-assets/route.ts | GET, POST | me | user | formData | 201 | nodejs/default/default | default | withApiEnvelope | - |
| /api/me/store/products/[id]/digital-assets/[assetId] | app/api/me/store/products/[id]/digital-assets/[assetId]/route.ts | DELETE, PATCH | me | user | json | unknown | nodejs/default/default | default | withApiEnvelope | - |
| /api/me/store/products/[id]/images | app/api/me/store/products/[id]/images/route.ts | GET, POST | me | user | json | 201 | default/default/default | default | withApiEnvelope | - |
| /api/me/store/products/[id]/images/[imageId] | app/api/me/store/products/[id]/images/[imageId]/route.ts | DELETE, PATCH | me | user | json | unknown | default/default/default | default | withApiEnvelope | - |
| /api/me/store/products/[id]/options | app/api/me/store/products/[id]/options/route.ts | GET, POST | me | user | json | 201 | default/default/default | default | withApiEnvelope | - |
| /api/me/store/products/[id]/options/[optionId] | app/api/me/store/products/[id]/options/[optionId]/route.ts | DELETE, PATCH | me | user | json | unknown | default/default/default | default | withApiEnvelope | - |
| /api/me/store/products/[id]/options/[optionId]/values | app/api/me/store/products/[id]/options/[optionId]/values/route.ts | GET, POST | me | user | json | 201 | default/default/default | default | withApiEnvelope | - |
| /api/me/store/products/[id]/options/[optionId]/values/[valueId] | app/api/me/store/products/[id]/options/[optionId]/values/[valueId]/route.ts | DELETE, PATCH | me | user | json | unknown | default/default/default | default | withApiEnvelope | - |
| /api/me/store/products/[id]/variants | app/api/me/store/products/[id]/variants/route.ts | GET, POST | me | user | json | 201 | default/default/default | default | withApiEnvelope | - |
| /api/me/store/products/[id]/variants/[variantId] | app/api/me/store/products/[id]/variants/[variantId]/route.ts | DELETE, PATCH | me | user | json | unknown | default/default/default | default | withApiEnvelope | - |
...
| /api/me/store/shipments/[shipmentId] | app/api/me/store/shipments/[shipmentId]/route.ts | DELETE, PATCH | me | user | json | unknown | default/default/default | default | withApiEnvelope | - |
| /api/me/store/shipping/methods/[methodId] | app/api/me/store/shipping/methods/[methodId]/route.ts | DELETE, GET, PATCH | me | user | json | unknown | default/default/default | default | withApiEnvelope | - |
| /api/me/store/shipping/methods/[methodId]/tiers | app/api/me/store/shipping/methods/[methodId]/tiers/route.ts | GET, POST | me | user | json | 201 | default/default/default | default | withApiEnvelope | - |
| /api/me/store/shipping/settings | app/api/me/store/shipping/settings/route.ts | GET, PATCH | me | user | json | unknown | default/default/default | default | withApiEnvelope | - |
| /api/me/store/shipping/tiers/[tierId] | app/api/me/store/shipping/tiers/[tierId]/route.ts | DELETE, GET, PATCH | me | user | json | unknown | default/default/default | default | withApiEnvelope | - |
| /api/me/store/shipping/zones | app/api/me/store/shipping/zones/route.ts | GET, POST | me | user | json | 201 | default/default/default | default | withApiEnvelope | - |
| /api/me/store/shipping/zones/[zoneId] | app/api/me/store/shipping/zones/[zoneId]/route.ts | DELETE, GET, PATCH | me | user | json | unknown | default/default/default | default | withApiEnvelope | - |
| /api/me/store/shipping/zones/[zoneId]/methods | app/api/me/store/shipping/zones/[zoneId]/methods/route.ts | GET, POST | me | user | json | 201 | default/default/default | default | withApiEnvelope | - |
...
| /api/organizacao/agenda/soft-blocks | app/api/organizacao/agenda/soft-blocks/route.ts | DELETE, PATCH, POST | organizacao | org, orgEmail, user | json | 200, 201, 403 | default/default/default | default | respond* | - |
...
| /api/organizacao/avaliacoes | app/api/organizacao/avaliacoes/route.ts | GET | organizacao | org, user | query | 403 | default/default/default | default | respond* | - |
...
| /api/organizacao/chat/canais | app/api/organizacao/chat/canais/route.ts | GET, POST | organizacao | org, orgEmail, user | json, query | 403 | default/default/default | default | respond* | - |
| /api/organizacao/chat/canais/[channelId]/mensagens | app/api/organizacao/chat/canais/[channelId]/mensagens/route.ts | GET, POST | organizacao | org, orgEmail, user | json, query | 403 | default/default/default | default | respond* | - |
| /api/organizacao/checkin | app/api/organizacao/checkin/route.ts | POST | organizacao | admin, org, orgEmail, user | json | 200, 403 | default/default/default | default | respond* | - |
| /api/organizacao/checkin/preview | app/api/organizacao/checkin/preview/route.ts | POST | organizacao | admin, org, orgEmail, user | json | 200, 403 | default/default/default | default | respond* | - |
...
| /api/organizacao/consentimentos/[userId] | app/api/organizacao/consentimentos/[userId]/route.ts | PUT | organizacao | org, orgEmail, user | json | 403 | default/default/default | default | respond* | - |
| /api/organizacao/crm/campanhas | app/api/organizacao/crm/campanhas/route.ts | GET, POST | organizacao | org, orgEmail, user | json | 403 | default/default/default | default | respond* | - |
| /api/organizacao/crm/campanhas/[campaignId]/enviar | app/api/organizacao/crm/campanhas/[campaignId]/enviar/route.ts | POST | organizacao | org, orgEmail, user | none detected | 403 | default/default/default | default | respond* | - |
...
| /api/organizacao/crm/clientes/[customerId]/notas | app/api/organizacao/crm/clientes/[customerId]/notas/route.ts | POST | organizacao | org, orgEmail, user | json | 403 | default/default/default | default | respond* | - |
| /api/organizacao/crm/clientes/[customerId]/tags | app/api/organizacao/crm/clientes/[customerId]/tags/route.ts | PUT | organizacao | org, orgEmail, user | json | 403 | default/default/default | default | respond* | - |
...
| /api/organizacao/crm/segmentos | app/api/organizacao/crm/segmentos/route.ts | GET, POST | organizacao | org, orgEmail, user | json | 403 | default/default/default | default | respond* | - |
...
| /api/organizacao/estatisticas/time-series | app/api/organizacao/estatisticas/time-series/route.ts | GET | organizacao | org, user | query | 400, 401, 403, 500 | default/default/default | default | withApiEnvelope | - |
...
| /api/organizacao/events/[id]/invite-token | app/api/organizacao/events/[id]/invite-token/route.ts | POST | organizacao | org, orgEmail, user | json | 403 | default/default/default | default | respond* | - |
| /api/organizacao/events/[id]/invites | app/api/organizacao/events/[id]/invites/route.ts | DELETE, GET, POST | organizacao | admin, org, orgEmail, user | json, query | 403, 404 | default/default/default | default | respond* | - |
| /api/organizacao/events/[id]/refund | app/api/organizacao/events/[id]/refund/route.ts | POST | organizacao | org, orgEmail, user | json | 403 | default/default/default | default | respond* | - |
| /api/organizacao/events/create | app/api/organizacao/events/create/route.ts | POST | organizacao | admin, org, orgEmail, user | json | 201, 403 | default/default/default | default | respond* | - |
...
| /api/organizacao/events/update | app/api/organizacao/events/update/route.ts | POST | organizacao | admin, org, orgEmail, user | json | 200, 400, 403 | default/default/default | default | respond* | - |
...
| /api/organizacao/finance/exports/fees | app/api/organizacao/finance/exports/fees/route.ts | GET | organizacao | org, user | query | 200, 403 | nodejs/force-dynamic/default | dynamic exported | respond* | - |
| /api/organizacao/finance/exports/ledger | app/api/organizacao/finance/exports/ledger/route.ts | GET | organizacao | org, user | query | 200, 403 | nodejs/force-dynamic/default | dynamic exported | respond* | - |
| /api/organizacao/finance/exports/payouts | app/api/organizacao/finance/exports/payouts/route.ts | GET | organizacao | org, user | query | 200, 403 | nodejs/force-dynamic/default | dynamic exported | respond* | - |
| /api/organizacao/finance/invoicing | app/api/organizacao/finance/invoicing/route.ts | GET, POST | organizacao | org, orgEmail, user | json | 200, 401, 403 | nodejs/force-dynamic/default | dynamic exported | respond* | - |
...
| /api/organizacao/inscricoes | app/api/organizacao/inscricoes/route.ts | GET, POST | organizacao | org, orgEmail, user | json | 200, 201, 403 | default/default/default | default | respond* | - |
| /api/organizacao/inscricoes/[id] | app/api/organizacao/inscricoes/[id]/route.ts | DELETE, GET, PATCH | organizacao | org, orgEmail, user | json | 200, 403 | default/default/default | default | respond* | - |
...
| /api/organizacao/inscricoes/[id]/submissions | app/api/organizacao/inscricoes/[id]/submissions/route.ts | GET, PATCH | organizacao | org, orgEmail, user | json, query | 200, 403 | default/default/default | default | respond* | - |
...
| /api/organizacao/loja | app/api/organizacao/loja/route.ts | GET, PATCH, POST | organizacao | org, orgEmail, user | json | 201 | default/default/default | default | withApiEnvelope | - |
| /api/organizacao/loja/bundles | app/api/organizacao/loja/bundles/route.ts | GET, POST | organizacao | org, user | json | 201 | default/default/default | default | withApiEnvelope | - |
| /api/organizacao/loja/bundles/[id] | app/api/organizacao/loja/bundles/[id]/route.ts | DELETE, PATCH | organizacao | org, user | json | unknown | default/default/default | default | withApiEnvelope | - |
| /api/organizacao/loja/bundles/[id]/items | app/api/organizacao/loja/bundles/[id]/items/route.ts | GET, POST | organizacao | org, user | json | 201 | default/default/default | default | withApiEnvelope | - |
| /api/organizacao/loja/bundles/[id]/items/[itemId] | app/api/organizacao/loja/bundles/[id]/items/[itemId]/route.ts | DELETE, PATCH | organizacao | org, user | json | unknown | default/default/default | default | withApiEnvelope | - |
| /api/organizacao/loja/categories | app/api/organizacao/loja/categories/route.ts | GET, POST | organizacao | org, user | json | 201 | default/default/default | default | withApiEnvelope | - |
| /api/organizacao/loja/categories/[id] | app/api/organizacao/loja/categories/[id]/route.ts | DELETE, PATCH | organizacao | org, user | json | unknown | default/default/default | default | withApiEnvelope | - |
| /api/organizacao/loja/orders | app/api/organizacao/loja/orders/route.ts | GET | organizacao | org, user | query | unknown | default/default/default | default | withApiEnvelope | - |
| /api/organizacao/loja/orders/[orderId] | app/api/organizacao/loja/orders/[orderId]/route.ts | GET, PATCH | organizacao | org, user | json | unknown | default/default/default | default | withApiEnvelope | - |
| /api/organizacao/loja/orders/[orderId]/shipments | app/api/organizacao/loja/orders/[orderId]/shipments/route.ts | POST | organizacao | org, user | json | 201 | default/default/default | default | withApiEnvelope | - |
| /api/organizacao/loja/overview | app/api/organizacao/loja/overview/route.ts | GET | organizacao | org, user | none detected | unknown | default/default/default | default | withApiEnvelope | - |
| /api/organizacao/loja/preview | app/api/organizacao/loja/preview/route.ts | GET | organizacao | org, user | none detected | unknown | default/default/default | default | withApiEnvelope | - |
| /api/organizacao/loja/settings | app/api/organizacao/loja/settings/route.ts | GET, PATCH | organizacao | org, user | json | unknown | default/default/default | default | withApiEnvelope | - |
| /api/organizacao/loja/products | app/api/organizacao/loja/products/route.ts | GET, POST | organizacao | org, user | json | 201 | default/default/default | default | withApiEnvelope | - |
| /api/organizacao/loja/products/[id] | app/api/organizacao/loja/products/[id]/route.ts | DELETE, PATCH | organizacao | org, user | json | unknown | default/default/default | default | withApiEnvelope | - |
| /api/organizacao/loja/products/[id]/digital-assets | app/api/organizacao/loja/products/[id]/digital-assets/route.ts | GET, POST | organizacao | org, user | formData | 201 | nodejs/default/default | default | withApiEnvelope | - |
| /api/organizacao/loja/products/[id]/digital-assets/[assetId] | app/api/organizacao/loja/products/[id]/digital-assets/[assetId]/route.ts | DELETE, PATCH | organizacao | org, user | json | unknown | nodejs/default/default | default | withApiEnvelope | - |
| /api/organizacao/loja/products/[id]/images | app/api/organizacao/loja/products/[id]/images/route.ts | GET, POST | organizacao | org, user | json | 201 | default/default/default | default | withApiEnvelope | - |
| /api/organizacao/loja/products/[id]/images/[imageId] | app/api/organizacao/loja/products/[id]/images/[imageId]/route.ts | DELETE, PATCH | organizacao | org, user | json | unknown | default/default/default | default | withApiEnvelope | - |
| /api/organizacao/loja/products/[id]/options | app/api/organizacao/loja/products/[id]/options/route.ts | GET, POST | organizacao | org, user | json | 201 | default/default/default | default | withApiEnvelope | - |
| /api/organizacao/loja/products/[id]/options/[optionId] | app/api/organizacao/loja/products/[id]/options/[optionId]/route.ts | DELETE, PATCH | organizacao | org, user | json | unknown | default/default/default | default | withApiEnvelope | - |
| /api/organizacao/loja/products/[id]/options/[optionId]/values | app/api/organizacao/loja/products/[id]/options/[optionId]/values/route.ts | GET, POST | organizacao | org, user | json | 201 | default/default/default | default | withApiEnvelope | - |
| /api/organizacao/loja/products/[id]/options/[optionId]/values/[valueId] | app/api/organizacao/loja/products/[id]/options/[optionId]/values/[valueId]/route.ts | DELETE, PATCH | organizacao | org, user | json | unknown | default/default/default | default | withApiEnvelope | - |
| /api/organizacao/loja/products/[id]/variants | app/api/organizacao/loja/products/[id]/variants/route.ts | GET, POST | organizacao | org, user | json | 201 | default/default/default | default | withApiEnvelope | - |
| /api/organizacao/loja/products/[id]/variants/[variantId] | app/api/organizacao/loja/products/[id]/variants/[variantId]/route.ts | DELETE, PATCH | organizacao | org, user | json | unknown | default/default/default | default | withApiEnvelope | - |
| /api/organizacao/loja/shipments/[shipmentId] | app/api/organizacao/loja/shipments/[shipmentId]/route.ts | DELETE, PATCH | organizacao | org, user | json | unknown | default/default/default | default | withApiEnvelope | - |
| /api/organizacao/loja/shipping/methods/[methodId] | app/api/organizacao/loja/shipping/methods/[methodId]/route.ts | DELETE, GET, PATCH | organizacao | org, user | json | unknown | default/default/default | default | withApiEnvelope | - |
| /api/organizacao/loja/shipping/methods/[methodId]/tiers | app/api/organizacao/loja/shipping/methods/[methodId]/tiers/route.ts | GET, POST | organizacao | org, user | json | 201 | default/default/default | default | withApiEnvelope | - |
| /api/organizacao/loja/shipping/settings | app/api/organizacao/loja/shipping/settings/route.ts | GET, PATCH | organizacao | org, user | json | unknown | default/default/default | default | withApiEnvelope | - |
| /api/organizacao/loja/shipping/tiers/[tierId] | app/api/organizacao/loja/shipping/tiers/[tierId]/route.ts | DELETE, GET, PATCH | organizacao | org, user | json | unknown | default/default/default | default | withApiEnvelope | - |
| /api/organizacao/loja/shipping/zones | app/api/organizacao/loja/shipping/zones/route.ts | GET, POST | organizacao | org, user | json | 201 | default/default/default | default | withApiEnvelope | - |
| /api/organizacao/loja/shipping/zones/[zoneId] | app/api/organizacao/loja/shipping/zones/[zoneId]/route.ts | DELETE, GET, PATCH | organizacao | org, user | json | unknown | default/default/default | default | withApiEnvelope | - |
| /api/organizacao/loja/shipping/zones/[zoneId]/methods | app/api/organizacao/loja/shipping/zones/[zoneId]/methods/route.ts | GET, POST | organizacao | org, user | json | 201 | default/default/default | default | withApiEnvelope | - |
| /api/organizacao/loyalty/programa | app/api/organizacao/loyalty/programa/route.ts | GET, PUT | organizacao | org, orgEmail, user | json | 403 | default/default/default | default | respond* | - |
| /api/organizacao/loyalty/recompensas | app/api/organizacao/loyalty/recompensas/route.ts | GET, POST | organizacao | org, orgEmail, user | json | 403 | default/default/default | default | respond* | - |
| /api/organizacao/loyalty/regras | app/api/organizacao/loyalty/regras/route.ts | GET, POST | organizacao | org, orgEmail, user | json | 403 | default/default/default | default | respond* | - |
...
| /api/organizacao/organizations/[id] | app/api/organizacao/organizations/[id]/route.ts | DELETE | organizacao | org, orgEmail, user | none detected | 200, 403 | default/default/default | default | respond* | - |
| /api/organizacao/organizations/leave | app/api/organizacao/organizations/leave/route.ts | POST | organizacao | org, orgEmail, user | json | 200, 403 | default/default/default | default | respond* | - |
| /api/organizacao/organizations/members | app/api/organizacao/organizations/members/route.ts | DELETE, GET, PATCH | organizacao | org, orgEmail, user | json, query | 200, 403 | default/default/default | default | respond* | - |
| /api/organizacao/organizations/members/invites | app/api/organizacao/organizations/members/invites/route.ts | GET, PATCH, POST | organizacao | org, orgEmail, user | json, query | 200, 201, 403 | default/default/default | default | respond* | - |
| /api/organizacao/organizations/members/permissions | app/api/organizacao/organizations/members/permissions/route.ts | GET, PATCH | organizacao | org, orgEmail, user | json, query | 200, 403 | default/default/default | default | respond* | - |
| /api/organizacao/organizations/owner/confirm | app/api/organizacao/organizations/owner/confirm/route.ts | POST | organizacao | org, orgEmail, user | json | 200, 403 | default/default/default | default | respond* | - |
| /api/organizacao/organizations/owner/transfer | app/api/organizacao/organizations/owner/transfer/route.ts | POST | organizacao | org, orgEmail, user | json | 200, 403 | default/default/default | default | respond* | - |
| /api/organizacao/organizations/settings/official-email | app/api/organizacao/organizations/settings/official-email/route.ts | POST | organizacao | org, user | json | 200 | default/default/default | default | respond* | - |
| /api/organizacao/organizations/settings/official-email/confirm | app/api/organizacao/organizations/settings/official-email/confirm/route.ts | POST | organizacao | org, user | json | 200 | default/default/default | default | respond* | - |
...
| /api/organizacao/padel/imports/inscritos | app/api/organizacao/padel/imports/inscritos/route.ts | POST | organizacao | org, orgEmail, user | formData | 200, 400, 403 | nodejs/default/default | default | respond* | - |
| /api/organizacao/padel/mix/create | app/api/organizacao/padel/mix/create/route.ts | POST | organizacao | org, orgEmail, user | json | 200, 403 | nodejs/default/default | default | withApiEnvelope | - |
...
| /api/organizacao/payouts/connect | app/api/organizacao/payouts/connect/route.ts | POST | organizacao | org, user | none detected | 200, 401, 403, 404, 409, 500 | nodejs/force-dynamic/default | dynamic exported | respond* | - |
| /api/organizacao/payouts/list | app/api/organizacao/payouts/list/route.ts | GET | organizacao | org, user | query | 200, 401, 403, 500 | default/default/default | default | respond* | - |
| /api/organizacao/payouts/settings | app/api/organizacao/payouts/settings/route.ts | POST | organizacao | org, user | json | 200, 400, 401, 403, 500 | nodejs/force-dynamic/default | dynamic exported | respond* | - |
| /api/organizacao/payouts/status | app/api/organizacao/payouts/status/route.ts | GET | organizacao | org, user | none detected | 401, 403, 500 | nodejs/force-dynamic/default | dynamic exported | respond* | - |
| /api/organizacao/payouts/summary | app/api/organizacao/payouts/summary/route.ts | GET | organizacao | org, user | none detected | 200, 401, 403, 500 | nodejs/force-dynamic/default | dynamic exported | respond* | - |
| /api/organizacao/payouts/webhook | app/api/organizacao/payouts/webhook/route.ts | POST | organizacao | webhook | text | 200, 400, 500 | nodejs/force-dynamic/default | dynamic exported | respond* | - |
| /api/organizacao/policies | app/api/organizacao/policies/route.ts | GET, POST | organizacao | org, orgEmail, user | json | 201, 403 | default/default/default | default | respond* | - |
| /api/organizacao/policies/[id] | app/api/organizacao/policies/[id]/route.ts | DELETE, PATCH | organizacao | org, orgEmail, user | json | 403 | default/default/default | default | respond* | - |
| /api/organizacao/promo | app/api/organizacao/promo/route.ts | DELETE, GET, PATCH, POST | organizacao | org, orgEmail, user | json | 403 | default/default/default | default | respond* | - |
...
| /api/organizacao/refunds/list | app/api/organizacao/refunds/list/route.ts | GET | organizacao | org, user | query | 200, 401, 403, 500 | default/default/default | default | respond* | - |
...
| /api/organizacao/trainers | app/api/organizacao/trainers/route.ts | GET, PATCH, POST | organizacao | org, orgEmail, user | json, query | 200, 403 | default/default/default | default | respond* | - |
| /api/organizacao/trainers/profile | app/api/organizacao/trainers/profile/route.ts | GET, PATCH | organizacao | org, orgEmail, user | json, query | 200, 403 | default/default/default | default | respond* | - |
| /api/organizacao/username | app/api/organizacao/username/route.ts | PATCH | organizacao | org, orgEmail, user | json | 200, 403 | nodejs/default/default | default | respond* | - |
...
| /api/organization/official-email | app/api/organization/official-email/route.ts | POST | public | none detected | json | 200 | default/default/default | default | respond* | - |
...
| /api/padel/pairings/swap/confirm/[token] | app/api/padel/pairings/swap/confirm/[token]/route.ts | POST | public | user | none detected | 400, 401, 404, 409 | nodejs/default/default | default | withApiEnvelope | - |
...
| /api/servicos/[id]/checkout | app/api/servicos/[id]/checkout/route.ts | POST | public | user | json | unknown | nodejs/default/default | default | respond* | - |
...
| /api/servicos/[id]/creditos/checkout | app/api/servicos/[id]/creditos/checkout/route.ts | POST | public | user | json | 400, 409 | nodejs/default/default | default | respond* | - |
...
| /api/store/checkout/prefill | app/api/store/checkout/prefill/route.ts | GET | public | user | query | unknown | default/default/default | default | withApiEnvelope | - |
