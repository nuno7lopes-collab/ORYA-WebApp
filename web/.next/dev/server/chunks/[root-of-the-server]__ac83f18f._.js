...
"[project]/app/api/padel/clubs/[id]/staff/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, { params }) {
    ...
    const staff = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].padelClubStaff.findMany({
        where: {
            padelClubId: club.id,
            deletedAt: null
        },
...
async function POST(req, { params }) {
    ...
    if (!email && !userId) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: false,
            error: "Indica o email ou userId do staff."
        }, {
            status: 400
        });
    }
    if (!padelRole) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: false,
            error: "Define um papel específico para Padel."
        }, {
            status: 400
        });
    }
    try {
        ...
        if (!resolvedUserId && email) {
            const foundUser = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.findFirst({
                where: {
        ...
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].padelClubStaff.findFirst({
            where: {
                padelClubId: club.id,
                deletedAt: null,
                OR: [
        ...
        if (staffId || existing) {
            ...
            staff = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].padelClubStaff.update({
                where: {
                    id: targetId,
                    padelClubId: club.id
                },
            ...
            staff = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].padelClubStaff.create({
                data
            });
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function DELETE(req, { params }) {
    ...
    if (!Number.isFinite(staffIdNum)) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ok: false,
        error: "INVALID_STAFF"
    }, {
        status: 400
    });
    const staff = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].padelClubStaff.findFirst({
        where: {
            id: staffIdNum,
            padelClubId: clubId,
            deletedAt: null
    ...
    if (!staff) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ok: false,
        error: "STAFF_NOT_FOUND"
    }, {
        status: 404
    });
    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].padelClubStaff.update({
        where: {
            id: staffIdNum
        },
        data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ac83f18f._.js.map