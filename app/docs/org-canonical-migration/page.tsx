...
export default function OrgCanonicalMigrationDocsPage() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-14 text-sm text-slate-200">
      <h1 className="text-2xl font-semibold text-white">Legacy route hard-removed (404)</h1>
      ...
      <ul className="mt-4 list-disc space-y-2 pl-5 text-slate-300">
        <li>
          Legacy web: <code>/organizacao/*</code> -&gt; <code>404 Not Found</code>
        </li>
        <li>
          Legacy API: <code>/api/organizacao/*</code> -&gt; <code>404 Not Found</code>
        </li>
        <li>
