...
export const CRON_JOBS: CronJobDefinition[] = [
  ...
  {
    key: "telemetry-rollup",
    envIntervalMs: "CRON_TELEMETRY_ROLLUP_INTERVAL_MS",
    defaultIntervalMs: 300_000,
    method: "POST",
  ...
  },
  {
    ...
    envIntervalMs: "CRON_TELEMETRY_RETENTION_INTERVAL_MS",
    defaultIntervalMs: 86_400_000,
    method: "POST",
    endpoint: "/api/cron/telemetry/retention",
  },
  {
    key: "loyalty-expire",
