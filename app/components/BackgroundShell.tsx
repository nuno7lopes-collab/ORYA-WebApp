...
const ORG_PREFIXES = ["/organizador"];
...
const BG_PRESETS: Record<BackgroundKey, BackgroundPreset> = {
  ...
  "orya-bg-event": {
    ...
    overlayOpacity: 0.9,
    skeletonSurface:
      "radial-gradient(circle at 22% 20%, rgba(107, 255, 255, 0.14), transparent 55%), radial-gradient(circle at 78% 18%, rgba(22, 70, 245, 0.2), transparent 60%), linear-gradient(160deg, rgba(12, 20, 36, 0.86) 0%, rgba(6, 10, 18, 0.96) 60%, rgba(4, 6, 12, 0.98) 100%)",
    skeletonSurfaceStrong:
      "radial-gradient(circle at 22% 20%, rgba(107, 255, 255, 0.1), transparent 55%), radial-gradient(circle at 78% 18%, rgba(22, 70, 245, 0.16), transparent 60%), linear-gradient(160deg, rgba(9, 15, 28, 0.92) 0%, rgba(5, 8, 16, 0.98) 62%, rgba(3, 5, 10, 1) 100%)",
  },
  "orya-bg-org": {
    color: "#05060a",
    image:
    ...
    overlayOpacity: 0.88,
    skeletonSurface:
      "radial-gradient(circle at 18% 20%, rgba(107, 255, 255, 0.12), transparent 55%), radial-gradient(circle at 84% 24%, rgba(255, 0, 200, 0.1), transparent 60%), linear-gradient(165deg, rgba(12, 18, 34, 0.86) 0%, rgba(6, 10, 18, 0.96) 60%, rgba(4, 6, 12, 0.98) 100%)",
    skeletonSurfaceStrong:
      "radial-gradient(circle at 18% 20%, rgba(107, 255, 255, 0.08), transparent 55%), radial-gradient(circle at 84% 24%, rgba(255, 0, 200, 0.08), transparent 60%), linear-gradient(165deg, rgba(9, 15, 28, 0.92) 0%, rgba(5, 8, 16, 0.98) 62%, rgba(3, 5, 10, 1) 100%)",
  },
};
