...
"[project]/app/api/users/search/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    try {
        const results = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].profile.findMany({
            where: {
                AND: [
                    {
                        isDeleted: false
        ...
        if (user && results.length > 0) {
            const followingRows = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].follows.findMany({
                where: {
                    follower_id: user.id,
                    following_id: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__563eab68._.js.map