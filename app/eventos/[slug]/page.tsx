  ...
  return {
    ...
    description:
      event.description && event.description.trim().length > 0
        ? event.description
        : `Descobre o ${eventLabel} ${baseTitle} em ${location} na ORYA.`,
  };
}
...
export default async function EventPage({
  ...
  const ticketLabelTitle = isPadel ? "Inscrições" : "Bilhetes";
  ...
  const descriptionText =
    event.description && event.description.trim().length > 0
      ...
      : `A descrição deste ${eventLabel} será atualizada em breve.`;
          ...
          <div className="orya-page-width mt-6 grid grid-cols-1 gap-6 px-4 md:px-8 lg:grid-cols-[1.1fr_0.9fr]">
                ...
                <div className="relative">
                  ...
                  {currentUserHasTicket && (
                    <div className="mt-4 inline-flex items-center gap-2 rounded-full border border-emerald-400/60 bg-emerald-500/15 px-3 py-1 text-xs text-emerald-100">
                      ...
                      <span>
                        Já tens {ticketLabel} para este {eventLabel}
                      </span>
                    </div>
                  )}
                  ...
                  <div className="mt-6 flex flex-wrap items-center gap-4">
                    {!eventEnded && (
                      ...
                      >
                        {event.isFree ? "Garantir lugar" : `Ver ${ticketLabelPlural}`}
            ...
            <div className="relative">
              ...
              <div className="relative h-full min-h-[260px] overflow-hidden rounded-[32px] border border-white/15 bg-white/5 shadow-[0_28px_70px_rgba(0,0,0,0.85)]">
                <Image
                  src={cover}
                  alt={`Capa do ${eventLabel} ${event.title}`}
                  fill
                  priority
                  fetchPriority="high"
        ...
        <section className="relative z-10 orya-page-width grid grid-cols-1 gap-12 px-6 pb-28 pt-10 md:grid-cols-3 md:px-10">
          ...
          <div className="space-y-12 md:col-span-2">
            ...
            >
              ...
              <h2 className="mt-3 text-2xl font-semibold">Resumo do {eventLabel}</h2>
            ...
            <section className="rounded-3xl border border-white/15 bg-white/5 p-6 shadow-[0_24px_60px_rgba(0,0,0,0.5)] backdrop-blur-2xl md:p-8">
              ...
              <p className="mt-2 text-xs text-white/60">
                Mantém-te atualizado pela página do {eventLabel}. Esta linha do tempo mostra o estado atual.
              </p>
            ...
            <section className="rounded-3xl border border-white/15 bg-white/5 p-6 shadow-[0_24px_60px_rgba(0,0,0,0.5)] backdrop-blur-2xl md:p-8" id="live">
              <div className="flex flex-wrap items-center justify-between gap-3">
                <div>
                  ...
                  <h3 className="mt-3 text-xl font-semibold">
                    {isPadel ? "Acompanhamento ao vivo" : `Live do ${eventLabel}`}
                  </h3>
                  <p className="mt-2 text-xs text-white/60">
                    {isPadel
                      ? "Acompanha jogos, brackets e ranking em tempo real."
                      : `Acompanha o ${eventLabel} com destaques, horários e informação atualizada.`}
                  </p>
                </div>
              ...
              {liveHubVisibility === "DISABLED" ? (
                <div className="mt-4 rounded-2xl border border-white/12 bg-black/40 px-4 py-3 text-sm text-white/70">
                  O LiveHub deste {eventLabel} está desativado.
                </div>
              ) : showLiveInline ? (
                <div className="mt-4">
                ...
                <div className="mt-4 rounded-2xl border border-white/12 bg-black/40 px-4 py-3 text-sm text-white/70">
                  {isPadel
                    ...
                    : `Abre o modo live para veres as atualizações do ${eventLabel}.`}
                </div>
              )}
            </section>
              ...
              <div className="relative rounded-[30px] border border-white/15 bg-[linear-gradient(140deg,rgba(255,255,255,0.16),rgba(2,6,16,0.78))] p-7 shadow-[0_28px_70px_rgba(0,0,0,0.75)] backdrop-blur-2xl">
                ...
                <div className="relative">
                  <div className="flex items-start justify-between gap-3">
                    <div>
                      <h3 className="text-xl font-semibold">{ticketLabelTitle}</h3>
                      <p className="text-xs text-white/60">
                        {isPadel ? "Inscrição segura com confirmação imediata." : "Compra segura com confirmação imediata."}
                      </p>
                    </div>
                    <span
                  ...
                  <div id="bilhetes" className="mt-4 scroll-mt-28">
                    {!eventEnded ? (
                      <div className="space-y-5 border-t border-white/12 pt-5">
                        <div className="flex items-center justify-between gap-2">
                          <h3 className="text-base font-semibold">
                            Seleciona {ticketPossessive} {ticketLabel}
                          </h3>
                                ...
                                <div className="flex items-center justify-between gap-3 rounded-xl border border-emerald-500/40 bg-emerald-500/15 px-3.5 py-2.5 text-sm text-emerald-100">
                                  <div>
                                    ...
                                    <p className="text-[11px] text-emerald-100/85">
                                      Basta garantir o teu lugar — não há custo de {ticketLabel}.
                                    </p>
                                  </div>
                                </div>
                            ...
                            {allowCheckout ? (
                              uiTickets.length === 0 ? (
                                <div className="rounded-xl border border-white/12 bg-black/45 px-3.5 py-2.5 text-sm text-white/80">
                                  Ainda não há waves configuradas para este {eventLabel}.
                                </div>
                              ) : allSoldOut ? (
                                <div className="rounded-xl border border-orange-400/40 bg-orange-500/15 px-3.5 py-2.5 text-sm text-orange-100">
                                  <div>
                                    <p className="font-semibold">{eventLabelTitle} esgotado</p>
                                    <p className="text-[11px] text-orange-100/85">
                                      Não há mais {ticketLabelPlural} disponíveis para este {eventLabel}.
                                    </p>
                                  </div>
                                </div>
                                ...
                                <div className="rounded-xl border border-yellow-400/40 bg-yellow-500/15 px-3.5 py-2.5 text-sm text-yellow-100">
                                  <div>
                                    <p className="font-semibold">
                                      {isPadel ? "Inscrições ainda não abriram" : "Vendas ainda não abriram"}
                                    </p>
                                    <p className="text-[11px] text-yellow-100/85">
                                      {isPadel
                                        ? `As inscrições para este ${eventLabel} ainda não abriram. Volta mais tarde!`
                                ...
                                <div className="rounded-xl border border-white/12 bg-black/45 px-3.5 py-2.5 text-sm text-white/80">
                                  <div>
                                    <p className="font-semibold">
                                      {isPadel ? "Inscrições encerradas" : "Vendas encerradas"}
                                    </p>
                                    <p className="text-[11px] text-white/70">
                                      {isPadel
                                        ? `As inscrições para este ${eventLabel} já encerraram.`
                        ...
                        {resales.length > 0 && (
                          <div className="mt-7 space-y-4 border-t border-white/15 pt-5">
                            <div className="flex items-center justify-between gap-2">
                              <h3 className="text-base font-semibold">
                                {ticketLabelTitle} entre utilizadores
                              </h3>
                            ...
                            <p className="text-xs text-white/65">
                              Estes {ticketLabelPlural} são vendidos por outros utilizadores da ORYA.
                                  ...
                                  <div className="flex flex-col gap-0.5">
                                    <div className="flex flex-wrap items-center gap-2">
                                      <span className="font-medium">
                                        {r.ticketTypeName ?? (isPadel ? "Inscrição ORYA" : "Bilhete ORYA")}
                                      </span>
                                      {r.seller && (
                      ...
                      <div className="rounded-xl border border-white/15 bg-black/60 px-4 py-3 text-sm text-white/85">
                        {isPadel
                          ? `Este ${eventLabel} já terminou. As ${ticketLabelPlural} deixaram de estar disponíveis.`
                          : "Este evento já terminou. Bilhetes e inscrições deixaram de estar disponíveis."}
                      </div>
                    )}
                  </div>
                </div>
