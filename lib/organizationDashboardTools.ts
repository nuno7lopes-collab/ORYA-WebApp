...
export const DASHBOARD_TOOL_ACTIVATION_CATALOG: DashboardToolActivationCard[] = [
  {
    ...
    title: "Eventos",
    summary: "Eventos publicos e privados com operacao completa.",
    bullets: ["Bilhetes e regras", "Participantes + check-in", "Operacao + anuncios"],
    flow: "Operações",
  ...
  },
  {
    ...
    title: "Reservas",
    summary: "Servicos e marcacoes com gestao diaria.",
    bullets: ["Servicos + disponibilidade", "Marcacoes + estados", "Calendario operacional"],
    flow: "Operações",
  ...
  },
  {
    ...
    title: "Padel",
    summary: "Operacao de clube e torneios competitivos.",
    bullets: ["Clubes + campos", "Torneios + equipas", "Gestao de calendario"],
    flow: "Operações",
  ...
  },
  {
    ...
    title: "Formularios",
    summary: "Recolha de inscricoes e dados operacionais.",
    bullets: ["Formularios rapidos", "Listas e vagas", "Exportacao de dados"],
    flow: "Operações",
    unlocks: ["inscricoes"],
  },
  {
    ...
    title: "Mensagens",
    summary: "Canal privado entre membros da organizacao.",
    bullets: ["Conversas da equipa", "Canais internos", "Historico completo"],
    flow: "Operações",
    unlocks: ["mensagens"],
  },
  {
    ...
    iconKey: "TOOL_LOJA",
    title: "Loja",
    summary: "Produtos fisicos e digitais com checkout unico.",
    bullets: ["Catalogo + imagens", "Portes + descontos", "Encomendas + envio"],
    flow: "Gestão",
    unlocks: ["loja"],
  },
];
