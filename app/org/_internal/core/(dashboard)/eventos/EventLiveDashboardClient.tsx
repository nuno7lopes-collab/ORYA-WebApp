...
import EventLivePrepClient from "@/app/org/_internal/core/(dashboard)/eventos/EventLivePrepClient";
import EventLiveClient from "@/app/eventos/[slug]/EventLiveClient";
import { TournamentLiveManager } from "@/app/org/_internal/core/(dashboard)/tournaments/[id]/live/page";
...
export default function EventLiveDashboardClient({ event, tournamentId, canManageLiveConfig }: Props) {
  ...
  const basePath = pathname ?? (organizationId ? `/org/${organizationId}/events/${event.id}/live` : "/org-hub/organizations");
