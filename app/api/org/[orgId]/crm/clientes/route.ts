...
async function _GET(req: NextRequest) {
  try {
      ...
      return {
        ...
        padel: item.padelProfile
          ? {
              ...
              preferredTimeBucket: item.padelProfile.preferredTimeBucket,
              offPeakRatio30d: item.padelProfile.offPeakRatio30d,
              reservationCount90d: item.padelProfile.reservationCount90d,
              lessonCount90d: item.padelProfile.lessonCount90d,
              tournamentCount90d: item.padelProfile.tournamentCount90d,
              avgSpendPerSessionCents90d: item.padelProfile.avgSpendPerSessionCents90d,
              lastNoShowAt: item.padelProfile.lastNoShowAt,
            }
          : null,
      };
    });
    ...
    console.error("GET /api/org/[orgId]/crm/clientes error:", err);
