...
_s(OrganizerPublicProfilePanel, "DbYzNSEnPfN6HtlPhxtmszb+b9A=", false, function() {
    return [
...
"[project]/app/organizador/OrganizerTour.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function OrganizerTour({ organizerId }) {
    ...
    const tourKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "OrganizerTour.useMemo[tourKey]": ()=>organizerId ? `${TOUR_KEY}:${organizerId}` : TOUR_KEY
    }["OrganizerTour.useMemo[tourKey]"], [
        organizerId
    ]);
    const progressKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "OrganizerTour.useMemo[progressKey]": ()=>organizerId ? `${TOUR_PROGRESS_KEY}:${organizerId}` : TOUR_PROGRESS_KEY
    }["OrganizerTour.useMemo[progressKey]"], [
        organizerId
    ]);
    const shouldShow = mounted && open;
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OrganizerTour.useEffect": ()=>{
            const id = requestAnimationFrame({
                "OrganizerTour.useEffect.id": ()=>{
                    setMounted(true);
                    const seenGlobal = ("TURBOPACK compile-time truthy", 1) ? localStorage.getItem(TOUR_GLOBAL_KEY) : "TURBOPACK unreachable";
                    const seen = ("TURBOPACK compile-time truthy", 1) ? localStorage.getItem(tourKey) : "TURBOPACK unreachable";
                    if (!seen && !seenGlobal) {
                        const savedStep = ("TURBOPACK compile-time truthy", 1) ? Number(localStorage.getItem(progressKey)) : "TURBOPACK unreachable";
                    ...
                    const handler = {
                        "OrganizerTour.useEffect.id.handler": ()=>{
                            if (("TURBOPACK compile-time value", "object") !== "undefined" && localStorage.getItem(TOUR_GLOBAL_KEY)) return;
                    ...
                    return ({
                        "OrganizerTour.useEffect.id": ()=>window.removeEventListener(TOUR_EVENT, handler)
                    })["OrganizerTour.useEffect.id"];
                }
            }["OrganizerTour.useEffect.id"]);
            return ({
                "OrganizerTour.useEffect": ()=>cancelAnimationFrame(id)
            })["OrganizerTour.useEffect"];
        }
    }["OrganizerTour.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OrganizerTour.useEffect": ()=>{
            const updateViewport = {
                "OrganizerTour.useEffect.updateViewport": ()=>{
            ...
            return ({
                "OrganizerTour.useEffect": ()=>window.removeEventListener("resize", updateViewport)
            })["OrganizerTour.useEffect"];
        }
    }["OrganizerTour.useEffect"], []);
    const step = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "OrganizerTour.useMemo[step]": ()=>steps[index]
    }["OrganizerTour.useMemo[step]"], [
        index
    ]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OrganizerTour.useEffect": ()=>{
            ...
            let observer = null;
            const tryResolve = {
                "OrganizerTour.useEffect.tryResolve": ()=>{
    ...
    const goNext = ()=>{
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$analytics$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["trackEvent"])("organizer_tour_next", {
            step: index
        });
    ...
    const finish = ()=>{
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$analytics$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["trackEvent"])("organizer_tour_finish");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OrganizerTour.useEffect": ()=>{
            if (highlightEnabled && anchorRect && step.anchor) {
                ...
                const el = selectors.map({
                    "OrganizerTour.useEffect.el": (sel)=>document.querySelector(sel)
                }["OrganizerTour.useEffect.el"]).find(Boolean);
                el?.scrollIntoView({
                    behavior: "smooth",
                    block: "center"
                });
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OrganizerTour.useEffect": ()=>{
            ...
            const handler = {
                "OrganizerTour.useEffect.handler": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OrganizerTour.useEffect": ()=>{
            const onKey = {
                "OrganizerTour.useEffect.onKey": (e)=>{
                    if (e.key === "Escape") {
                        finish();
                    }
                }
            }["OrganizerTour.useEffect.onKey"];
            if (!shouldShow) return;
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    !isMobile && arrowPos && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    }, void 0, true) : step.ctaLabel ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        onClick: ()=>{
                                            if (step.ctaAction?.type === "navigate" && step.ctaAction.href) {
                                                router.push(step.ctaAction.href);
                                            }
...
_s(OrganizerTour, "m23UwEzgLE1BmmJQMYIyitmeHTA=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
...
_c = OrganizerTour;
var _c;
__turbopack_context__.k.register(_c, "OrganizerTour");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=app_organizador_d6c0a014._.js.map