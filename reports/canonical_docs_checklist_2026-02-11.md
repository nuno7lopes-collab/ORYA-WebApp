...
- [N/A] L25: - Planeamento, backlog e itens “a fazer” vivem em `docs/planning_registry.md` (**NÃO-NORMATIVO**).
...
- [N/A] L572:   - input: {sourceType, sourceId, buyerIdentityRef?, pricingSnapshotHash?, idempotencyKey}
...
- [N/A] L3372: 	•	Conteúdo movido para `docs/planning_registry.md` (bloco de roadmap/check-in, não-normativo).
- [N/A] L3374: ⸻
...
- [N/A] L3616: - `app/api/cron/payouts/release/route.ts`
...
## Source: docs/planning_registry.md
...
- [N/A] L8: - A fonte normativa continua a ser apenas `docs/ssot_registry.md`.
