// app/org/(dashboard)/eventos/[id]/live/page.tsx
...
import EventLiveDashboardClient from "@/app/org/_internal/core/(dashboard)/eventos/EventLiveDashboardClient";
...
export default async function OrganizationEventLivePrepPage({ params }: PageProps) {
  ...
  const fallbackHref = event.templateType === "PADEL" ? "/org/padel/torneios" : "/org/eventos";
