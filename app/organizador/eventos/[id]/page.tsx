...
export default async function OrganizerEventDetailPage({ params }: PageProps) {
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,_#1a1030_0,_#050509_45%,_#02020a_100%)] text-white">
        ...
        <div className="max-w-6xl mx-auto px-5 py-4 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <a
              ...
              className="px-3 py-1.5 rounded-xl border border-white/20 bg-white/5 text-[11px] text-white/80 hover:bg-white/10 transition"
            >
              ← Voltar à lista
            </a>
            <a
              href={`/eventos/${event.slug}`}
              className="px-3 py-1.5 rounded-xl bg-gradient-to-r from-[#FF00C8] via-[#6BFFFF] to-[#1646F5] text-[11px] font-semibold text-black hover:scale-[1.03] active:scale-95 transition-transform shadow-[0_0_22px_rgba(107,255,255,0.7)]"
            >
              Ver página pública
            </a>
          </div>
      ...
      <section className="max-w-6xl mx-auto px-5 py-8 md:py-10 space-y-7">
        {/* Bloco topo: info evento + métricas resumo */}
        <div className="grid grid-cols-1 md:grid-cols-[minmax(0,1.7fr)_minmax(0,1.1fr)] gap-5">
          {/* Info evento */}
